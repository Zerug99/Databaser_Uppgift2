  ...
  ("9789189516076", "Fourth Wing", "Rebecca Yarros", 340.50, 7);
  ...
  SELECT -- allt matchande och börjar från Orderrader
  Orderrader.orderradID,
  Best ällningar.OrderID,
  Böcker.titel,
  Orderrader.Antal,
  Kunder.KundID,
  Kunder.Namn,
  ...
  SELECT -- omatchad data som börjar från kunder. 
  Kunder.KundID,
  Orderrader.orderradID,
  Böcker.titel,
  Orderrader.Antal,
