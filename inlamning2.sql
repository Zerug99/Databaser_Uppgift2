...
("9789198616880", "Alvblod", "Andrzej Sapkowski", 234.00, 4),
("9781407132082", "The Hunger Games", "Suzanne Collins", 150.00, 10),
("9789189516076", "Fourth Wing", "Rebecca Yarros", 199.50, 7);
...
FROM beställningar 
INNER JOIN Kunder
ON beställningar.KundID = Kunder.KundID;
-- Vad man gör här är att man kopplar ihop två tabeller så man får se bara matchande data, och det som måste matcha då är FK med PK, t.ex skulle (OrderID rad 5) ha KundID NULL, kanske betalar kunden med cash, så kommer det inte kunna ge matchande datan för det finns ingen FK till att koppla till den andra tabellen. 
